...
<head>
    ...
    <title> PHP - Arrays ( Vetore e Matrizes)</title>
...
<body>
    ...
    <ul>
        <li>Banda que gosto: <?= $bandas[3] ?></li>
    ...
    <h2> Array associados</h2>
    <p> Lista de dados baseada em uma chave associativa ( na pratica, é um nome/identificação que você dá), é um valor para ele ( o dado em si)
    ...
    <h3> Acessando dados searray associativos</h3>
    <p>Nome do curso: <b><?= $curso["titulo"] ?></b></p>
    <p>CH: <b><?= $curso["cargaHoraria"] ?> horas</b></p>
    ...
    $planoDeEstudos = [
        ...
        ["Teoiria das Cores", "Photoshop", "Canvas", "UX/UI"]

    ];
    // Martriz de arrays associativos
    $clientes = [
        [
            "nome" => "Gabriel",
            "me_devendo" => 1000
    ...
    <p>o <?= $clientes[0]["nome"] ?> medeve <?=  $clientes[0]["me_devendo"] ?></p>
