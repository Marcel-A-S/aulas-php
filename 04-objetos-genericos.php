...
// Adicionando propriedade/atributos  a objeto
$usuario->codigo = 1;
$usuario->nome = "Jon Oliva";
$usuario->email = "jon@savatage.com";
$usuario->idade = 70;
$usuario->telefone = ["11-2135-0300", "11-98765-4321"];
$usuario->endereco = [
    "lagradouro" => "Rua Guapé",
     "numero" => "123A",
     "bairro" => "Penha",
     "Cep" => "03639-000" 
     ];
...
<li>Celular: 
    <a href="tel:+55<?= $usuario->telefone[1] ?>">
        <?= $usuario->telefone[1] ?>
</a>
</li>
...
<li>peso: <?= $usuario->caracteristica->peso ?></li>
</ul>


<h2>Convertendo objetos em array</h2>
<?php
...
$arrayPedido =(array) $pedido;// castin (conversão)
?>
