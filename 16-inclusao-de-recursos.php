...
<body>
    ...
    <div class="conteiner">
        ...
        <h1>Inclusão der Recursos</h1>
        <hr>

        <p>Utilizado os comandos <code>include</code> e/ou <code>require</code> para importar arquivos com recursos de qualquer natureza,permitindo assim a reutilização de código.</p>
